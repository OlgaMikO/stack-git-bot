...
@RestController @RequiredArgsConstructor public class BotApiController {

    public ArrayList<Long> exampleID = new ArrayList<>(Arrays.asList(0L, 1L));

    private final Bot bot;

    @PostMapping("/updates") public ResponseEntity<?> linkUpdate(@RequestBody @Valid LinkUpdateRequest request) {
